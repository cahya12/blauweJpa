...
import com.verzinen.ugm.model.error.Bean;
import com.verzinen.ugm.model.error.DiagnosticOption;
...
public class HttpJMXClient18 {
  ...
  public static void main(String[] args) {
	  ...
	  String qry_name="com.sun.management:type=HotSpotDiagnostic";
	  ...
	  */
	  try {
		 ...
		 // System.out.println(json);
		  ...
		  List<Bean> _bbs_ = AmbariJMXUtil.json2pojo(json);
		  System.out.println("----------------------------------------");
		  ...
		  for (Bean b: _bbs_) {
			 ...
			 // System.out.println( b.getDiagnosticOptions() );
			  
			  for (DiagnosticOption d : b.getDiagnosticOptions()) {
				  System.out.println( d.getName() );
				  System.out.println( d.getOrigin());
				  System.out.println( d.getValue() );
				  System.out.println( d.getWriteable() );
			  }
