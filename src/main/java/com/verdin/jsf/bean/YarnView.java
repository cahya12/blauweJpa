...
@Named
@ViewScoped
public class YarnView implements Serializable {
	
	static final long serialVersionUID = 1237l;
	
	static Logger logger = Logger.getLogger(YarnView.class);
	...
	static String DEFAULT_SERVICE = "YARN";
	...
	public  void init()  {
		...
		String json =  _client.ambari_configurtion_rest_client (DEFAULT_SERVICE);
		 ...
		 config = getCurrentConfigurationByType("yarn-site");
