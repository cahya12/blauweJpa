...
@ApplicationScoped
public class HBaseRestClientEJB {
	
	 static Logger logger = Logger.getLogger(HBaseRestClientEJB.class);
	   ...
	   */
	    	...
	    	// curl -u admin:admin -H "X-Requested-By: ambari" -X GET  http://192.168.3.221:8080/api/v1/clusters/H2SO4/configurations?type=hive-site
	     	...
	     	String URL_SECURED_BASIC_AUTHENTICATION = 
	     			"http://192.168.3.132:8080/api/v1/clusters/C10H16/configurations/service_config_versions/?service_name=HBASE";
