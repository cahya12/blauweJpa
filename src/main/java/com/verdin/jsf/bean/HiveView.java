...
@Named
@ViewScoped
public class HiveView implements Serializable {
	
	static final long serialVersionUID = 1237l;
	
	static Logger logger = Logger.getLogger(HiveView.class);
	...
	static String DEFAULT_SERVICE = "HIVE";
	...
	public  void init() {
		...
		AmbariRestClient _client  =  new AmbariRestClient(HOSTNAME, CLUSTER);
		 ...
		 config = getCurrentConfigurationByType("hive-site");
