...
public class POJOItemsResultUtil {
	static Logger logger = Logger.getLogger(POJOItemsResultUtil.class);
	
	  public static POJOItemsResult json2pojo(String json) throws Exception {
		  
		  
		  POJOItemsResult  _hbase =  new POJOItemsResult();
	      	     ...
	      	     //  JsonElement _conf = j.get("Config");
	      	       ...
	      	       for (JsonElement _json_e : _confs) {
	      	    	...
	      	    	//   Map<String, Object> _properties_as_map  =   toMap(_properties);
	      	    	 ...
	      	    	 List<Param> _array_properties = toArrayList(_properties );  
	      	    	   ...
	      	    	   c.set_Properties(_array_properties);
	     	    	...
	     	    	//  properties_attributes
	      	    	  ...
	      	    	  List<Param> _array_properties_attr = toArrayList(_properties_attr );  
	      	    	   
	      	    	   c.set_PropertiesAttributes(_array_properties_attr);
  ...
  public static List<Param> toArrayList(JsonObject object) throws Exception {
		  
		  Map<String, Object> map = toMap( object);
		  
		  List<Param> array = new ArrayList<Param>();
		  
		  for (Map.Entry<String, Object> e: map.entrySet()) {
			  
			  Param _p = new Param(e.getKey(), e.getValue().toString());
