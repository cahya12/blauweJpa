...
public class Course implements Serializable {
	...
	@ManyToMany(mappedBy = "courseSaya")
	private Set<Faculties> facultySaya = new HashSet<>();
	...
	public Set<Faculties> getFacultySaya() {
		return facultySaya;
	}

	public void setFacultySaya(Set<Faculties> facultySaya) {
		this.facultySaya = facultySaya;
	}
