...
import com.verzinen.jpa.entity.*;
...
public class Main {
	...
	public void run() {
		...
		try {
			...
			factory = Persistence.createEntityManagerFactory("BlauweUnit");
			
			entityManager = factory.createEntityManager();
			
			LOGGER.log(Level.INFO, "running .... 1");
			
			
			persistPerson(entityManager);
			
			LOGGER.log(Level.INFO, "running .... 2");
			
			persistGeek(entityManager);
			
			LOGGER.log(Level.INFO, "running .... 3");
			
			loadPersons(entityManager);
			
			LOGGER.log(Level.INFO, "running .... 4");
			
			addPhones(entityManager);
			
			LOGGER.log(Level.INFO, "running .... 5");
			
			createProject(entityManager);
			
			LOGGER.log(Level.INFO, "running .... 6");
